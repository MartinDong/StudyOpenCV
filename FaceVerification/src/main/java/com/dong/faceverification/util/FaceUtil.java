package com.dong.faceverification.util;
...
import static org.bytedeco.opencv.global.opencv_imgproc.CV_COMP_INTERSECT;
...
public final class FaceUtil {
    ...
    public static double compare(Context context , String fileName1 , String fileName2) {
        try {
            ...
            IplImage image1    = cvLoadImage(pathFile1 , 0);
            IplImage image2    = cvLoadImage(pathFile2 , 0);
